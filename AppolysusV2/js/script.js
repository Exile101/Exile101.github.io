$(window).load(function(){
	...
	$('.t_overlay').eq(0).click(function(){
		$('.viewer').animate({scrollLeft:0},1800);
	});

	$('.t_overlay').eq(1).click(function(){
		$('.viewer').animate({scrollLeft:1000},1800);
	});

	$('.t_overlay').eq(2).click(function(){
		$('.viewer').animate({scrollLeft:2000},1800);
	});

	$('.t_overlay').eq(3).click(function(){
		$('.viewer').animate({scrollLeft:3000},1800);
	});

	$('.t_overlay').eq(4).click(function(){
		$('.viewer').animate({scrollLeft:4000},1800);
	});
})